...
namespace VJPBase.API
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<CuaHangXeDbContext>();
            services.AddCors();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, CuaHangXeDbContext context)
        {
            //Temp create 2 user
        ...
        private void createTestUser(CuaHangXeDbContext context)
        {
